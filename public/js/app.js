...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    editProduct: function editProduct(data, id) {
      this.data = data;
      this.isEdit = true;
      this.id = id;
    },
    update: function update() {
      ...
      axios.put('/api/product/' + this.id, this.data).then(function (resp) {
  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "card-body" }, [
        ...
        "form",
        {
          ...
          on: {
            submit: function($event) {
              ...
              _vm.isEdit ? _vm.update() : _vm.save()
            }
          }
        },
        [
            ...
            _c("input", {
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.$set(_vm.data, "product_name", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
          ...
          _vm._v(" "),
          _c("div", { staticClass: "form-group" }, [
            _c("label", [_vm._v("Quantity in stock")]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
          ...
          _vm._v(" "),
          _c("div", { staticClass: "form-group" }, [
            _c("label", [_vm._v("Price Per Item")]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
      ...
      _c("div", { staticClass: "table-responsive" }, [
        _c(
          "table",
          { staticClass: "table table-striped table-bordered table-condensed" },
          [
            _vm._m(0),
            _vm._v(" "),
            _c(
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", [_vm._v("Price Per Item")]),
        _vm._v(" "),
        _c("th", [_vm._v("Datetime submitted")]),
        _vm._v(" "),
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('products', __webpack_require__(/*! ./components/ProductComponent.vue */ "./resources/js/components/ProductComponent.vue")["default"]);
/**
...
__webpack_require__(/*! /opt/lampp/htdocs/skill_test1/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /opt/lampp/htdocs/skill_test1/resources/sass/app.scss */"./resources/sass/app.scss");
